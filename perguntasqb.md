---
title: Questionário Base - As Perguntas
permalink: perguntasqb.html
layout: default
---
...
<p><em><strong>COMO FAZER:</strong></em> Copie o nome dos arquivos que o ME utilizou para montar os tópicos de Aula. Consulte essa tabela<sup class="footnote-ref"><a href="#fn1" id="fnref1">1</a></sup> com a lista oficial da bibliografia</p>
<p><em><strong>A Pergunta:</strong></em> Copie aqui a referência presente no Tópico de Aula</p>
<p><em><strong>Tipo de Resposta:</strong></em> <mark>Referências</mark></p>
...
<p><em><strong>Exemplo</strong></em><sup class="footnote-ref"><a href="#fn2" id="fnref2">2</a></sup></p>
<h2 id="conceitos">Conceitos</h2>
<p><em><strong>O QUE É:</strong></em> Nessa parte, deve-se citar os conceitos que a pessoa precisa saber para conseguir bom aproveitamento no estudo do material</p>
<p><em><strong>COMO FAZER:</strong></em> Aqui, basicamente, está se respondendo a pergunta: O que a pessoa tem que revisar antes de ver essa aula?</p>
<p><em><strong>A Pergunta:</strong></em> Descreva os conteúdos que o aluno precisaria revisar antes de estudar essa aula</p>
<p><em><strong>Tipo de Resposta:</strong></em> <mark>Texto</mark></p>
<p><em><strong>Código de Resposta:</strong></em></p>
<pre><code>---
==Resposta(Texto)==
{
...
<p><em><strong>Exemplo</strong></em><sup class="footnote-ref"><a href="#fn3" id="fnref3">3</a></sup></p>
<h2 id="introdução">Introdução</h2>
<p><em><strong>O QUE É:</strong></em> Um parágrafo curto que explana rapidamente quais tópicos iremos ver nessa aula</p>
<p><em><strong>COMO FAZER:</strong></em> Use a descrição da aula e modifique suas palavras</p>
<p><em><strong>A Pergunta:</strong></em> Descreva quais assuntos serão abordados nesta aula</p>
<p>***Tipo de Resposta:***<mark>Texto</mark></p>
<p><em><strong>Código de Resposta:</strong></em></p>
<pre><code>---
==Resposta(Texto)==
{
...
<li>Uma alegoria para o funcionamento de um sistema ou equipamento:  <iframe id="ytplayer" type="text/html" width="720" height="405" src="https://www.youtube.com/embed/zQGOcOUBi6s?autoplay=0&amp;cc_load_policy=1&amp;controls=0&amp;end=80&amp;modestbranding=1&amp;rel=0&amp;showinfo=0" allowfullscreen="">&#9;&#9;     &#9;&#10;</iframe></li>
</ul>
</li>
...
<p><mark>Resposta(Template){cartao_2}{14}</mark><br>
{<br>
<mark>Resposta(Flashcard Interativo)</mark><br>
{</p>
...
<td align="right"><strong>Título</strong></td>
<td align="center">Unidades de Medida</td>
<td align="center">Se extendermos a ordem de grandeza para o tamanho de orgãos,…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Imagem A</strong></td>
<td align="center">[O Rim]<img src="https://image.ibb.co/dpYpso/rim.png" alt="enter image description here">[<a href="http://B.io">B.io</a>][2018]</td>
<td align="center">…como o rim humano, percebe-se o quanto um órgão é complexo.</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Texto 1</strong></td>
<td align="center">12 cm</td>
<td align="center">Com apenas 12 cm,…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Imagem B</strong></td>
<td align="center">[Mão Humana]<img src="https://image.ibb.co/mVJB58/m_o.png" alt="">[StockImages][2018]</td>
<td align="center">…do tamanho da sua mão, seu par de rins…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>
></rect><g class="label" transform="translate(0,0)"><g transform="translate(-59.203125,-13)"><foreignObject width="118.40625" height="26"><div xmlns="http://www.w3.org/1999/xhtml" style="display: inline-block; white-space: nowrap;">O corpo humano</div></foreignObject></g></g></g></g></g></g></svg></div>
...
<p><mark>Resposta(Texto)</mark><br>
{<br>
Em anatomia funcional, aprendemos que a função que um órgão desempenha no organismo depende da especialização de sua estrutura. Vimos que as subdisciplinas da anatomia são a anatomia macroscópica, a anatomia microscópica e a anatomia do desenvolvimento.</p>
<p>Também aprendemos que um organismo é resultado das conexões funcionais entre os níveis mais simples. E por fim, vimos quais são as unidades de medida utilizadas, micrômetro (μm) para as células, centímetro (cm) para os órgãos e metro (m) para o corpo.<br>
}</p>
<pre><code> ---
</code></pre>
 <a href="#fnref15" class="footnote-backref">↩︎</a></li>
<li id="fn16" class="footnote-item"><pre><code>---
</code></pre>
<p><mark>Resposta(Template){cartao_1}{16}</mark><br>
{<br>
<mark>Resposta(Flashcard Interativo)</mark><br>
{</p>
...
<tr>
<td align="right"><strong>Título</strong></td>
<td align="center">O Que Vimos na Aula</td>
<td align="center">Bem, Pessoal, nossa aula está chegando ao fim.</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Subtítulo 1</strong></td>
<td align="center">Anatomia Funcional</td>
<td align="center">Nela vimos que Anatomia Funcional…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 1</strong></td>
<td align="center">Estudo das características estruturais e sua contribuição funcional no organismo</td>
<td align="center">estuda a função que um órgão desempenha no organismo, e como sua função depende da especialização de sua estrutura.</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Subtítulo 2</strong></td>
<td align="center">Anatomia Macroscópica</td>
<td align="center">Também vimos que existem diversas divisões na anatomia, como…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 1</strong></td>
<td align="center">Regional</td>
<td align="center">…a Anatomia Regional, que visualiza somente as partes integrantes da sua área de estudo.</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 2</strong></td>
<td align="center">Sistêmica</td>
<td align="center">A anatomia Sistêmica, que estuda as partes do corpo em grupos divididos pelo tipo de função que exercem, como o estudo do sistema respiratório, como pulmão, traquéia, etc.</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 3</strong></td>
<td align="center">De superfície</td>
<td align="center">E finalmente, a anatomia de superfície, útil na localização de entradas na pele para injeção de fármacos ou coleta de sangue, por exemplo.</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Subtítulo 3</strong></td>
<td align="center">Anatomia Microscópica</td>
<td align="center">Na anatomia microscópica, se necessita de instrumentos ópticos para o estudo de…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 1</strong></td>
<td align="center">Células</td>
<td align="center">…células…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 2</strong></td>
<td align="center">Tecidos</td>
<td align="center">…e tecidos, além de ser uma área importante na pesquisa…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 3</strong></td>
<td align="center">Desenvolvimento de Doenças</td>
<td align="center">…de doenças que ocorrem a nível celular;</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Subtítulo 4</strong></td>
<td align="center">Outros ramos da anatomia</td>
<td align="center">Em Outros ramos da anatomia,…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 1</strong></td>
<td align="center">Anatomia do Desenvolvimento</td>
<td align="center">…se estuda o desenvolvimento do corpo humano…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 3</strong></td>
<td align="center">Patologia</td>
<td align="center">…e as doenças que o acometem em certos estágios da vida,…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 2</strong></td>
<td align="center">Embriologia</td>
<td align="center">…desde o estágio embrionário até a velhice.</td>
<td align="center"><strong>Audio</strong></td>
</tr>
</tbody>
</table><p>}<br>
...
<p><mark>Resposta(Template){cartao_2}{17}</mark><br>
{<br>
<mark>Resposta(Flashcard Interativo)</mark><br>
{</p>
...
<td align="right"><strong>Título</strong></td>
<td align="center">O Que Vimos na Aula</td>
<td align="center">Em seguida, vimos os…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Subtítulo 1</strong></td>
...
<tr>
<td align="right"><strong>Bullet 1</strong></td>
<td align="center">Átomos</td>
<td align="center">…onde temos átomos, as peças chave para a construção de moléculas;</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 2</strong></td>
<td align="center">Moléculas</td>
<td align="center">As moléculas, cuja utilidade vai desde alimentar a célula como também compô-la;</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 3</strong></td>
<td align="center">Células</td>
<td align="center">A célula, o equivalente biológico ao do átomo, para seres vivos. Temos mais de um trilhão delas em nosso corpo;</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 4</strong></td>
<td align="center">Tecidos</td>
<td align="center">A seguir vimos os tecidos, conjuntos de células que executam a mesma função unidas em grupo;</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 5</strong></td>
<td align="center">Órgãos</td>
<td align="center">Logo depois os órgãos, grupos de tipos de tecido unidos para executar tarefas biologicamente avançadas;</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 6</strong></td>
<td align="center">Sistemas</td>
<td align="center">E finalmente chegamos aos sistemas, grupos de órgãos com funções semelhantes se unindo para executar tarefas complexas, como a digestão dos alimentos;</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 7</strong></td>
<td align="center">Organismo</td>
<td align="center">Até chegarmos ao nível estrutural do Organismo, Nós;</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Subtítulo 2</strong></td>
<td align="center">Unidades de medida</td>
<td align="center">Em Unidades de medida, aprendemos…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Imagem A</strong></td>
<td align="center">[Ordem de Grandeza]<img src="https://s1.static.brasilescola.uol.com.br/artigos/a-ordem-grandeza-uma-das-ferramentas-necessarias-para-estudo-fisica-572b4abbb058b.jpg?i=https://brasilescola.uol.com.br/upload/conteudo/images/a-ordem-grandeza-uma-das-ferramentas-necessarias-para-estudo-fisica-572b4abbb058b.jpg&amp;w=600&amp;h=350&amp;c=FFFFFF&amp;t=1" alt="**Elemento**">[Brasil Escola][2018]</td>
<td align="center">…um pouco sobre a ordem de grandeza na medição dos nossos diversos objetos de estudo,…</td>
<td align="center"><strong>áudio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 1</strong></td>
<td align="center">Células - (μm) micrômetro</td>
<td align="center">…das células, onde as medimos em micrômetros,…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 2</strong></td>
<td align="center">Órgãos - (cm) centímetro</td>
<td align="center">…os órgãos, onde os medimos em centímetros,…</td>
<td align="center"><strong>Audio</strong></td>
</tr>
<tr>
<td align="right"><strong>Bullet 3</strong></td>
<td align="center">Corpo - (m) metro</td>
<td align="center">…e o nosso corpo, que medimos em metros.</td>
<td align="center"><strong>Audio</strong></td>
</tr>
</tbody>
</table><p>}<br>
...
<pre><code>---
 ...
 <a href="#fnref16" class="footnote-backref">↩︎</a></li>
<li id="fn17" class="footnote-item"><pre><code>---
</code></pre>
<p><mark>Resposta(Exercício){Marieb}</mark><br>
{<br>
Qual é a diferença entre histologia e radiografia?<br>
}<br>
<mark>Resposta(Exercício){Marieb}</mark><br>
{<br>
Defina o que é tecido. Liste os quatro tipos de tecido no corpo e descreva brevemente a função de cada um deles.<br>
}<br>
<mark>Resposta(Exercício){Marieb}</mark><br>
{<br>
Cite o sistema orgânico descrito em cada um dos itens que se seguem:</p>
<ol>
<li>elimina dejetos e regula o equilíbrio de água e de íons no corpo;</li>
<li>sistema de controle de ação rápida que integra as atividades do corpo;</li>
<li>fornece sangue com oxigênio e retira o dióxido de carbono.</li>
</ol>
<p>}</p>
<pre><code>---
</code></pre>
 <a href="#fnref17" class="footnote-backref">↩︎</a></li>
<li id="fn18" class="footnote-item"><pre><code>---
</code></pre>
<p><mark>Resposta(Resolução)</mark><br>
{<br>
Podemos afirmar que:</p>
<ul>
<li>Histologia é o estudo microscópico da estrutura dos tecidos;</li>
<li>Radiologia é o estudo das estruturas internas do corpo a partir de raios X e outras técnicas de imagem, como ressonância magnética e ultrassonografia.</li>
</ul>
<p>}</p>
<pre><code>---
</code></pre>
<p><mark>Resposta(Resolução)</mark><br>
{<br>
Podemos definir tecido como um grupo de células de estrutura semelhante e que compartilhem de uma função comum. Quanto aos quatro tipos tecidos, eles são:</p>
<ul>
<li><strong>Tecido epitelial:</strong> um tecido de cobertura ou forro;</li>
<li><strong>Tecido conjuntivo:</strong>  tecido que funciona como apoio e proteção;</li>
<li><strong>Tecido muscular:</strong> Tecido que produz o movimento;</li>
<li><strong>Tecido nervoso:</strong> Tecido que permite a comunicação interna por impulsos elétricos e garante a transmissão de informação pelo corpo.</li>
</ul>
<p>}</p>
<pre><code>---
</code></pre>
<p><mark>Resposta(Resolução)</mark><br>
{<br>
Vamos responder cada alternativa:</p>
<ol>
<li>O sistema urinário elimina resíduos, regula a água e controla o equilíbrio dos íons.</li>
<li>O sistema nervoso é um sistema de controle de ação rápida</li>
<li>O sistema respiratório fornece sangue com oxigênio e remove dióxido de carbono da nossa corrente sanguínea.</li>
</ol>
<p>}</p>
<pre><code>---
</code></pre>
 <a href="#fnref18" class="footnote-backref">↩︎</a></li>
<li id="fn19" class="footnote-item"><pre><code>---
</code></pre>
<p><mark>Resposta(Livre){Texto}</mark><br>
{<br>
A maioria dos termos anatômicos se baseia em palavras do grego antigo e do latim. Por exemplo, braço vem do grego brachium; o osso da coxa é o fêmur, que vem da palavra latina femur, que significa coxa. Essa terminologia, que entrou em uso quando o latim era a língua oficial da ciência, fornece a nomenclatura padrão utilizada pelos cientistas mundo afora, em qualquer idioma.</p>
<p>Por exemplo, a palavra hepatite é composta de hepata, “fígado”, e itis, “inflamação”; portanto, hepatite é uma inflamação do fígado.<br>
}</p>
<pre><code>---
</code></pre>
 <a href="#fnref19" class="footnote-backref">↩︎</a></li>
<li id="fn20" class="footnote-item"><pre><code>---
</code></pre>
<p><mark>Resposta(Livre){Texto}</mark><br>
{<br>
Para saber mais, consulte Terminologia Médica Para Leigos, de [Beverley Henderson], editora  Alta Books, 1ª Edição, 2015)<br>
}</p>
<pre><code>---
</code></pre>
 <a href="#fnref20" class="footnote-backref">↩︎</a></li>
<li id="fn21" class="footnote-item"><p><strong>Membro Expulso:</strong> Membros da RDResoluções que foram expulsos da empresa por acusação de fraude, plágio de material ou inadequação ao nosso <strong>ritmo de trabalho</strong>.</p>
<ul>
<li>Membros Expulsos não tem direito ao recebimento de nenhum material que  ainda faltaria ser pago;</li>
<li>Eles podem ser executados judicialmente, caso o material produzido ou entregue fora do prazo cause dano ou prejuízo para a RDResoluções;</li>
<li>Eles podem ser intimados judicialmente a ressarcir a empresa pelo pagamento dos materiais ou pelos prejuízos da quebra do prazo de entrega;
<ul>
<li>O valor pago pelo material será registrado em cartório como “via de protesto”;</li>
<li>Uma via de protesto mantém a dívida de uma pessoa ativa por <strong>um período não menor que 20 anos,</strong> caso esta dívida possa ser comprovada via documentação e/ou contrato de prestação de serviços ou venda;</li>
</ul>
</li>
</ul>
